	...
	return (
		<div
			...
			<ul style={{ margin: "0 0 8px", paddingLeft: "12px" }}>
				<li>
					<b>Add to Compass:</b> Right-click selected text in any file or terminal to quickly add context to your
					current task! Plus, when you see a lightbulb icon, select 'Fix with Cline' to have Cline fix errors in your
					code.
				</li>
				<li>
