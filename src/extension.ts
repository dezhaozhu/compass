...
export function activate(context: vscode.ExtensionContext) {
	outputChannel = vscode.window.createOutputChannel("Compass")
	context.subscriptions.push(outputChannel)

	Logger.initialize(outputChannel)
	Logger.log("Compass extension activated")
	...
	const openClineInNewTab = async () => {
		Logger.log("Opening Compass in new tab")
		...
		const panel = vscode.window.createWebviewPanel(ClineProvider.tabPanelId, "Compass", targetCol, {
			enableScripts: true,
...
export function deactivate() {
	...
	Logger.log("Compass extension deactivated")
}
